...
if not esta_autenticado():
    ...
    # Botão de setup público — só aparece se a BD não existir
    st.divider()
    with st.expander("⚙️ Primeira instalação? Clica aqui"):
        st.caption("Cria o Google Sheet com todas as worksheets necessárias.")
        if st.button("🚀 Inicializar Base de Dados", type="primary"):
            ...
            from auth import criar_admin_inicial
            criar_admin_inicial()
            st.success("✅ Base de dados criada! Faz login com: cervejariacelsogestao@gmail.com / celso2024")
